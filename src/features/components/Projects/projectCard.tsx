    ...
    >
      ...
      <div className="p-6 flex flex-col justify-between h-[240px]">
        ...
        <div className="mt-2 pt-1 flex items-center justify-between">
          ...
          {/* Status Badge */}
          <span className="text-xs px-3 py-1 rounded-full bg-green-500/20 dark:bg-green-500/10 text-green-700
          dark:text-green-400 border border-green-500/20 flex items-center gap-2">
            <div className="h-2 w-2 bg-green-700 dark:bg-green-400 rounded-full animate-pulse"></div>
            {project.status}
          </span>
