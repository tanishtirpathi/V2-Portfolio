        ...
        <section className="mx-auto w-full max-w-5xl px-4 py-8">
            ...
            <div className="space-y-6">
                {BuildingDetail.map((item) => (
                    ...
                    >
                        <div className="relative h-56 w-full overflow-hidden rounded-xl md:h-full md:min-h-[240px]">
                            <Image
                        ...
                        <div className="flex flex-col justify-center gap-4">
                            <h3 className="text-2xl font-semibold text-neutral-900 dark:text-white">{item.buildingName}</h3>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-fit rounded-lg border border-neutral-900 px-4 py-2 text-sm
